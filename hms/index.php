...
<html>
	...
	<body style="background: #f2f2f2;">
		...
		<div class="mySlides fade">
		  <img id="1" src="Images/grandastoria.jpg" style="width:100%">
		  <div class="text">ENJOY THE DREAM EXPERIENCE</div>
		</div>

		<div class="mySlides fade">
		  <img id="2" src="Images/grandastoria1.jpg" style="width:100%">
		  <div class="text">REDEFINE LUXURY</div>
		</div>

		<div class="mySlides fade">
		  <img id="3" src="Images/grandastoria2.jpg" style="width:100%">
